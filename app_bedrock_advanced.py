...
class Me:
    ...
    def system_prompt(self):
        prompt = (
            ...
            f"STRICT RULE: If a user asks ANYTHING that is not explicitly covered in the documents provided below, "
            f"you MUST call the record_unknown_question tool BEFORE responding. "
            f"This includes personal questions (birthday, age, hobbies unrelated to work, etc.), "
            f"questions about topics not in the documents, or anything you are uncertain about. "
            f"Never answer with 'I don't know' or 'that information is not available' without FIRST calling record_unknown_question. "
            f"After calling the tool, tell the user the question has been recorded and {self.name} will follow up. "
